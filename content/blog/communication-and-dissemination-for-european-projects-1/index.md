...
- projects
- working-package
original_url: https://www.danielebailo.it/2015/09/10/communication-and-dissemination-for-european-projects-1/
migration_source: wordpress-personale
cover: /uploads/2015/09/Europe_flags-1.png
---
...
Some commercial tools exist already. Some examples are [active.collab](https://www.activecollab.com/)

, [Asana](https://asana.com/)

, [Basecamp](https://basecamp.com/) and many other.
...
2. **Files and images repository:** a common area for uploading/downloading files and exchange them with members and stakeholders. It is also a fundamental tool to store and categorize images and other dissemination material. 

![download](/uploads/2015/09/download.jpeg)

**This tool should support permissions** (some pages should be available to the general public without writing rights). According to the community needs (number of envisioned files, average size of each file etc), this tool may require a good amount of starage space (e.g. 3 Terabytes).
...
Your project may require special additional tools. For instance, if your keyword is *organization*, then some tool to keep track of the deadlines, tasks, activities etc. could be very useful (the latest - [Luca](https://www.linkedin.com/in/lucapost/it) thanks! - I stumbled upon is [wrike.com](http://wrike.com)

).

Or, if you focus on training and interactive teaching experiences for internal members, tools like [Moodle](https://moodle.org/) could do the job.
