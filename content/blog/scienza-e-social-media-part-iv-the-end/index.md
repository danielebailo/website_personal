...
- tecnology
- tecnology-ict
original_url: https://www.danielebailo.it/2015/12/19/scienza-e-social-media-part-iv-the-end/
migration_source: wordpress-personale
cover: /uploads/2015/12/jesse-orrico-60373-1-scaled.jpg
---
...
Il possesso di dati può essere in maniera abbastanza semplice correlato ad una ricchezza economica: le possibilità offerte dagli strumenti statistici e informatici di esplorare i dati  ([data mining](http://it.wikipedia.org/wiki/Data_mining)

) permette infatti di trarre informazioni preziose utilizzabili strategicamente in ambito economico. Questa azione, tra l'altro, viene promossa a livello intercontinentale (Stati Uniti ed Europa) con azioni che tendono a diffondere le politiche di [open data](http://it.wikipedia.org/wiki/Dati_aperti)

, ovvero politiche che favoriscono l'apertura a tutti di tutti i dati (si vedano i due esempi italiani, a livello [nazionale](http://www.dati.gov.it/) e [regionale](http://www.opendata.provincia.roma.it/)
...
- **Il problema dello “SPAM”**: un grosso problema da arginare è, inoltre, quello dei dati senza significato (il cosiddetto [spam](http://it.wikipedia.org/wiki/Spam)

, nel gergo informatico utilizzato soprattuto in relazione alla posta elettronica indesiderata).
