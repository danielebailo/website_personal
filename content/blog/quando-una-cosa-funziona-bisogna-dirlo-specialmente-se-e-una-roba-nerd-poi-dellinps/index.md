...
- riflessioni
- tecnology
original_url: https://www.danielebailo.it/2013/06/19/quando-una-cosa-funziona-bisogna-dirlo-specialmente-se-e-una-roba-nerd-poi-dellinps/
migration_source: wordpress-personale
cover: /uploads/2013/06/Library_Pengo-1.jpg
---

Ho provato un senso di  soddisfazione - quasi di liberazione -  quando, volendo verificare se ho una remota possibilità di andare in pensione (e comunque la risposta è "no, creperai lavorando"), mi sono collegato al [sito dell'INPS](http://www.inps.it/portale/default.aspx)

.

![Guida-Fisco-Contributi-Volontari-Inps-2012](/uploads/2013/06/guida-fisco-contributi-volontari-inps-2012-e1371573373389.jpe)
...
Ma quel bel portale di [servizi al cittadino](https://serviziweb2.inps.it/ServiziCittadino/servlet/avvio.SrvlMenu?S=S) funziona, e pure bene. Si può consultare un sacco di roba: i contributi versati, i certificati di malattia, il cud, dichiarazioni dei redditi... insomma tutta la propria esistenza burocratico-economica.

Il top viene raggiunto col [servizio telefonico](http://www.inps.it/portale/default.aspx?iMenu=22&bi=14&link=%3Cbr+%2f%3EAl+telefono)

, per il quale non è necessario nessun pin, password ecc.

![skype-click-to-call](/uploads/2013/06/skype-click-to-call.png)
...
![7661627-3d-rendering-di-robot-con-un-telefono-tradizionale](/uploads/2013/06/7661627-3d-rendering-di-robot-con-un-telefono-tradizionale.jpe)

Operatore Computerizzato: "Dica il suo nome"
...
Ma vero pure che  - una volta tanto - abbiamo un bel servizio che funziona. E anche che, in un panorama generale di uffici pubblici in cui *informatizzazione e dematerializzazione* sono parole che riempiono i documenti ufficiali ma fanno una gran fatica a prendere piede, **l'INPS ha messo in piedi un servizio fico** (per approfondire la parola "fico" ti consiglio di leggere [questo articolo](http://danielebailo.wordpress.com/2013/05/11/miles-davis-faceva-a-cazzotti/ "MIles Davis faceva a cazzotti")
...
Header Photo credit: **Peter Halasz**. ([User:Pengo](https://en.wikipedia.org/wiki/User:Pengo "w:User:Pengo")

) from wikimedia commons https://commons.wikimedia.org/wiki/File:Library\_Pengo.jpg#globalusage
